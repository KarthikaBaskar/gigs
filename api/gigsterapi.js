...
exports.listgig = function(req, res) {
  var query = "SELECT btr_projects.*, btr_users.username FROM btr_projects left JOIN btr_users ON btr_projects.userId = btr_users.userId order by btr_projects.postedon DESC LIMIT 10";
